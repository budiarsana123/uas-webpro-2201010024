...
<html lang="en">
  <head>
    ...
    <title>Gunawan Restaurant</title>
  </head>
  <body>
  ...
  <!-- Jumbotron -->
      <div class="jumbotron jumbotron-fluid text-center">
        <div class="container">
          <h1 class="display-4"><span class="font-weight-bold">GUNAWAN RESTAURANT</span></h1>
          <hr>
  ...
  <!-- Navbar -->
      <nav class="navbar navbar-expand-lg  bg-dark">
        <div class="container">
        <a class="navbar-brand text-white" href="admin.php"><strong>Gunawan</strong> Restaurant</a>
  ...
  <!-- Menu -->    
      <div class="container">
        <div class="judul text-center mt-5">
          <h3 class="font-weight-bold">GUNAWAN RESTAURANT</h3>
          <h5>Jl.Penelokan, Kintamani, Bangli
          <br>Buka Jam <strong>08:00 - 17:00</strong></h5>
        </div>
  ...
  <!-- Awal Footer -->
      ...
      <div class="container">
        <div class="row footer-body">
          <div class="col-md-6">
          <div class="copyright">
            <strong>Copyright</strong> <i class="far fa-copyright"></i> 2023 -  Designed by NyomanBudiarsana</p>
          </div>
          </div>
